    ...
    >
      ...
      <FadeIn delay={0.1} x={-80} y={0} duration={0.9} className="absolute top-[4%] left-[1%] sm:left-[2%] md:left-[4%]">
        <img
          ...
          alt=""
          className="w-[120px] sm:w-[160px] md:w-[210px] opacity-70"
          draggable={false}
        />
      </FadeIn>
      ...
      <FadeIn delay={0.25} x={-80} y={0} duration={0.9} className="absolute bottom-[8%] left-[3%] sm:left-[6%] md:left-[10%]">
        <img
          ...
          alt=""
          className="w-[100px] sm:w-[140px] md:w-[180px] opacity-70"
          draggable={false}
        />
      </FadeIn>
      ...
      <FadeIn delay={0.3} x={80} y={0} duration={0.9} className="absolute bottom-[8%] right-[3%] sm:right-[6%] md:right-[10%]">
        <img
          ...
          alt=""
          className="w-[130px] sm:w-[170px] md:w-[220px] opacity-70"
          draggable={false}
        />
      </FadeIn>
      ...
      <div className="flex flex-col items-center gap-10 sm:gap-14 md:gap-16 relative z-10">
        ...
        <AnimatedText
          text="With more than two years of experience in cybersecurity, i focus on SOC operations, penetration testing, and incident response. I truly enjoy working with complex threat landscapes that require sharp analytical thinking and precision. Let's build something secure together!"
